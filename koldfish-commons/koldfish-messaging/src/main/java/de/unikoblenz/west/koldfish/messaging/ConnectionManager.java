...
public class ConnectionManager {
  ...
  public static synchronized Connection getConnection(String userName, String password,
    ...
    return getConnectionUnsynchronized(userName, password, brokerURL, new String[0]);
  }

  public static synchronized Connection getConnection(String userName, String password,
      String brokerURL, String... trustedPackages) throws JMSException {
    return getConnectionUnsynchronized(userName, password, brokerURL, trustedPackages);
  }

  private static Connection getConnectionUnsynchronized(String userName, String password,
      String brokerURL, String... trustedPackages) throws JMSException {
  ...
  public static synchronized void closeConnection(Connection connection) throws JMSException {
    Set<String> key = null;
